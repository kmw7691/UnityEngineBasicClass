        ...
        static void Main(string[] args)
        {
            ...
            switch (player.state)
            {
                ...
                case PlayerStates.Move:
                    Console.WriteLine("플레이어는 움직이고 있다");
                    break;
                case PlayerStates.Jump:
                    Console.WriteLine("플레이어는 점프하고 있다");
                    break;
                case PlayerStates.Dash:
                    Console.WriteLine("플레이어는 돌진하고 있다");
                    break;
                case PlayerStates.Attack:
                    {
                        Console.WriteLine("플레이어는 공격하고 있다");
                ...
                case PlayerStates.Hurt:
                    Console.WriteLine("플레이어는 공격받고 있다");
                    break;
