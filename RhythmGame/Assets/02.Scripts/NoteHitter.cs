...
public class NoteHitter : MonoBehaviour
{
    ...
    private void Hit()
    {
        ...
        //Debug.Log($"try hit {transform.position.y + HIT_JUDGE_RANGE_MISS + NoteSpawnManager.Instance.NoteSpeedScale * HIT_JUDGE_RANGE_SPEED_GAIN} ~  {transform.position.y - HIT_JUDGE_RANGE_MISS - NoteSpawnManager.Instance.NoteSpeedScale * HIT_JUDGE_RANGE_SPEED_GAIN}");
        // 일단 범위내 모든 노트 감지
