...
public class NoteSpawnManager : MonoBehaviour
{
    ...
    public float NoteFallingDistance => _spawnersParent.transform.position.y - _hittersParent.position.y;
    ...
    IEnumerator E_Init()
    {
        ...
        // WaitUntil 객체 : Func<bool>의 반환값이 true가 될때까지 기다렸다가 다음 yeild 실행하는 객체
